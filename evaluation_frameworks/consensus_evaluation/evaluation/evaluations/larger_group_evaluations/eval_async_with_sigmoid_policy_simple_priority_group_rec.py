...
class EvalLargeAsyncWithSigmoidPolicySimplePriorityGroupRec(ConsensusExperimentBase):
    ...
    def make_table(self, results: Dict[str, Dict[str, Any]]) -> str:
        ...
        cap = (
            ...
            rf"async sigmoid group rec, $(center={center}, steepness={steepness}, c\_init={c_init}, "
        ...
        return latex_rfc_table_group_types_by_biases(
            ...
            metric_key="average",
            caption=cap,
            label="tab:large_async_sigmoid_group_rfc_by_bias",
        )


if __name__ == "__main__":
    autorun(EvalLargeAsyncWithSigmoidPolicySimplePriorityGroupRec)
